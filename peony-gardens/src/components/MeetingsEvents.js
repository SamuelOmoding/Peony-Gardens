...
//         aria-expanded={isDropdownOpen}
//       >
//         MeetingsEvents <span className="ml-1">▼</span>
//       </button>

//       {isDropdownOpen && (
//         <ul className="absolute left-0 mt-2 bg-white text-gray-900 shadow-lg rounded-md w-64 z-50" role="menu">
//           <li className="px-4 py-3 hover:bg-gray-100" role="menuitem">
//             <Link to="/MeetingsEvents/double-room" className="font-thin block text-gray-900 hover:text-gray-800" onClick={() => setIsDropdownOpen(false)}>
//               MEETS & CONFERENCES
//             </Link>
//           </li>
//           <li className="px-4 py-3 hover:bg-gray-100" role="menuitem">
//             <Link to="/MeetingsEvents/twin-triple-room" className="block text-gray-900 hover:text-gray-800" onClick={() => setIsDropdownOpen(false)}>
//               WEDDINGS & EVENTS
//             </Link>
//           </li>
//           <li className="px-4 py-3 hover:bg-gray-100" role="menuitem">
//             <Link to="/MeetingsEvents/family-room" className="block text-gray-900 hover:text-gray-800" onClick={() => setIsDropdownOpen(false)}>
//               TEAM BUILDING
//             </Link>
//           </li>
//         </ul>
