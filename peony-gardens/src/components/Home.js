...
// Ensure the paths to CustomArrows and ActivitySlider are correct
    ...
    <div id="home" className="relative min-h-screen">
      ...
      <div className="relative w-full h-screen">
        ...
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 z-30 bg-white bg-opacity-45 p-5 rounded-t-lg shadow-md w-full max-w-4xl">
          <h2 className="text-2xl text-center font-bold mb-4">Reserve Your Stay</h2>
          <div className="flex space-x-4">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center space-x-2">
                <button onClick={decrementRooms} className="border p-2 rounded hover:bg-gray-200">-</button>
                <input type="text" value={rooms} readOnly className="w-16 text-center border p-2 rounded" />
                <button onClick={incrementRooms} className="border p-2 rounded hover:bg-gray-200">+</button>
              </div>
            </div>
            <div className="flex flex-col">
              <label className="font-bold mb-1">Guests</label>
              <div className="flex items-center space-x-2">
                <button onClick={decrementGuests} className="border p-2 rounded hover:bg-gray-200">-</button>
                <input type="text" value={guests} readOnly className="w-16 text-center border p-2 rounded" />
                <button onClick={incrementGuests} className="border p-2 rounded hover:bg-gray-200">+</button>
              </div>
            </div>
            <div className="flex flex-col items-end">
              <label className="font-bold mb-1">Have a promotion code?</label>
              <input type="text" placeholder="Enter promo code" className="border p-2 rounded mb-2" />
              <button className="bg-orange-600 text-white py-2 px-4 rounded">Check Availability</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative p-5 z-20 mt-9 bg-yellow-700 bg-opacity-55 max-h-[600px] max-w-8xl mx-auto rounded-lg">
        <h2 className="text-black text-2xl font-bold py-2">Welcome to Peony Gardens.</h2>
        <div className="relative w-full h-[500px] overflow-hidden rounded">
          <video src={Video} className="absolute inset-0 w-full h-full object-cover" autoPlay muted controls />
        </div>
      </div>
      ...
      <div className="relative p-5 z-20 mt-9 bg-yellow-700 bg-opacity-55 max-h-[1000px] max-w-8xl mx-auto rounded-lg text-center">
        ...
        <h3 className="text-3xl font-bold mb-2">Welcome to Peony Gardens Hotel</h3>
      ...
      <div className="relative z-20 mt-12 bg-yellow-700 bg-opacity-55 py-8">
        <div className="text-center mb-6">
          ...
          <p className="text-1xl font-semibold text-gray-900">Discover exciting activities to enjoy during your stay.</p>
        </div>
        <div className="w-4/5 p-4 mx-auto text-center">
          <p className="text-gray-900">
            Get away to get closer. Peony Gardens provides the perfect atmosphere for bonding and reflection.
          </p>
        </div>
      ...
      {/* Footer Section */}
      <div className="relative z-20 bg-black text-white py-12 px-4 mt-12">
        <div className="text-center mb-6">
          <h2 className="text-3xl font-bold mb-6 text-yellow-500">WHERE TO FIND US</h2>
          <p className="text-gray-400">Located in Mauko, Busia with mesmerizing views.</p>
        </div>
        <div className="flex flex-col lg:flex-row justify-center space-y-6 lg:space-y-0 lg:space-x-6">
          ...
          <div className="w-full lg:w-1/2 text-left px-6 text-gray-300">
            <p className="font-bold text-lg text-yellow-500">ADDRESS:</p>
            <p>Peony Gardens Hotel, Hospital Road, Mauko, Busia.</p>
            <p className="font-bold text-lg text-yellow-500">RESERVATION NO 1:</p>
            <p>+254 700 949 004</p>
            <p className="font-bold text-lg text-yellow-500">EMAIL:</p>
        ...
        <div className="text-center mt-8">
          <p className="text-lg font-semibold text-yellow-500">#PeonyGardensHotel</p>
          <div className="flex justify-center my-4">
            <img src={Travel} alt="Travel Wishlist Logo" className="h-20 w-20" />
          </div>
          <div className="text-center text-gray-400 py-2">
            <p>© 2024. Peony Gardens. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
